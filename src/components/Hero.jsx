        ...
        <div className="flex flex-wrap">
            ...
            >
              ...
              <a
                ...
                className="rounded-lg cursor-pointer bg-blue-600 mb-3 px-3 py-3 text-lg font-semibold text-white shadow-md transition hover:bg-slate-950"
              >
                View Resume
              </a>
              ...
              <a
                ...
                className="rounded-lg cursor-pointer bg-purple-700 mb-3 px-3 py-3 text-lg font-semibold text-white shadow-md transition hover:bg-slate-950"
              >
                Download Resume
              </a>
            </motion.div>
